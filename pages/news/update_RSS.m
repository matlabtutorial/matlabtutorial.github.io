...
for i_entry = 1:n_entry
    ...
    newFeed = "{% include callout.html content=""<b>[" + S.entry(i_entry).title + "]("+S.entry(i_entry).link.hrefAttribute + ")</b>, " ...
        + newtime + "<br><br>요약: " + S.entry(i_entry).content + "<br><br> [기사 전문 보기](" ...
        + S.entry(i_entry).link.hrefAttribute + ")"" type = ""primary"" %}";
